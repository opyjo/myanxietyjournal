import type { MedicationKind, MedicationStatusValue, Mood } from "./types";
...
export const moodOptions: Array<{ value: Mood; label: string; tone: string }> = [
...
export const medicationKindOptions: Array<{ value: MedicationKind; label: string }> = [
  { value: "medication", label: "Medication" },
  { value: "supplement", label: "Supplement" },
];

export const medicationStatusOptions: Array<{
  value: MedicationStatusValue;
  label: string;
}> = [
